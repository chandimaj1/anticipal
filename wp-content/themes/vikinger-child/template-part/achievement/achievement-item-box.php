 ...
 */
  ...
  $isQuest = false;
  if (($args['achievement']['achievement_type'] === 'quest')){ 
    $isQuest=true;
  }
...
<div class="achievement-item-box">
  ...
  <!-- Show only cover photo on header if quest -->
  <?php
    if ($isQuest):
  ?>
    <div class="achievement-item-image-cover">
  ...
  <div class="achievement-item-box-info">
    ...
    <?php if ($achievement_image_wrap && !$isQuest) : ?>
    ...
    <?php endif; ?>
      ...
      ?>
      <p class="achievement-item-box-text"><?php echo esc_html($args['achievement']['post_excerpt']); ?></p>
      <?php
        endif;
      ?>
      <!-- /ACHIEVEMENT ITEM BOX TEXT -->
